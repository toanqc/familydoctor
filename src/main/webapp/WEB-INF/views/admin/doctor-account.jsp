...
<div class="content">
	<div class="margin-top-middle margin-left gray-text font-size-small">
		<a class="text-underline" href="<spring:url value="/admin" />"><spring:message
				code="label.home" /></a> > Edit Doctor Information
	</div>
	...
	<div class="margin-left-large margin-top-middle">
		...
		<spring:url value="/admin/doctor/${doctor.doctorId}" var="url"
			htmlEscape="true" />
			...
			<table class="data-table">
				<tr>
					...
					<td class="text-align-right"><form:input path="lastName"
							id="lastName" maxlength="10" size="14" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="text-align-right"><form:input
							path="address.zipcode" id="zipcode" maxlength="5" size="10" /></td>
				</tr>
				<tr>
